...
\begin{itemize}
\item \textbf{I Pay}~I can pay for your conference registration and travel in advance using the lab's P-card.  Usually we do this together for efficiency.
\item \textbf{You Pay (and get reimbursed)}~Everything else (e.g., hotel, food, local transport) you pay yourself (e.g., using your own credit card) and then submit reimbursement requests to the university. 
\begin{itemize}
