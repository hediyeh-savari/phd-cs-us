...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    ``Little'' is subjective!  In general we are generous with co-authorship.  We don't seek co-authors to help with the work, but if it happens that someone can help make the work better, we will share the credits. Even if we did 99\% of the work, but can't do the other 1\%, and someone else can help with that 1\%, then we should give them co-authorship. The person who did most of the work is still the first author, etc.  The point is that if we can't ship the work without that 1\%, then that 1\% is highly important and deserves co-authorship.
