...
\section{Advisor Guide: Answers to Common Questions}
Adapted from this \href{https://www.cs.columbia.edu/wp-content/uploads/2019/03/Get-Advisor.pdf}{advising guide} for my 
...
\begin{enumerate}[label=\arabic*.]
    ...
    I did my undergraduate and Master's in CS at Penn State University. Then I did my Ph.D. in CS in the University of New Mexico-Albuquerque and then a postdoc at the University of Maryland (in \href{https://plum-umd.github.io}{PLUM lab}). I started wanting to work on evolutionary computing, and then gradually changed to software engineering, programming languages, and formal methods.  Outside of academia I have interned at the Naval Research Lab and worked at Lockheed Martin. 
...
\subsection{Advising Style \& Meetings}
...
\begin{enumerate}[label=\arabic*.]
    ...
    I will suggest directions and ideas, but I expect my students to be able to work independently and take ownership of their projects. My students---including undergrads---need to be self-motivated and take initiative in their work.  
...
\subsection{Research Areas \& Projects}
...
\begin{enumerate}[label=\arabic*.]
    ...
    Actually, this question is kind of weird (but it was on the \href{https://www.cs.columbia.edu/wp-content/uploads/2019/03/Get-Advisor.pdf}{original list}). During PhD we train you to be researchers, and so if your post-graduate career is not research, then you are not directly using the skills you learn in the PhD. Still, many other skills that you learn---being independent, problem solving, read/write technical papers, endure my advising style, etc---are applicable to many careers.
...
\subsection{Expectations \& Progress}
...
\subsection{Funding \& Financial Support}
...
\subsection{Recruitment \& Fit / Placement}\label{sec:recruitment}
...
\subsection{Co-Advising \& External Collaborations}
...
\begin{enumerate}[label=\arabic*.]
    ...
    I \emph{expect} this to happen. At some point, you will know more than me in your topic of interest. Depending on your projects, I may introduce students to researchers or faculty who are experts in that area and collaborate with them so they can help you in your project. For example, KimHao works with Quoc-Sang at Facebook on build systems, and Hai works with Matt Dwyer at UVA on DNN verification. In short, if you become better than me in your area, then I've done my job and you're ready to graduate.  
    
    Note that if you want to change or try a research direction that I don't have much expertise or interest in, then I can't help you much there. I can try to find another faculty member who can help you, but if you want to work on something completely different, then we may need to discuss switching advisors. This is common in academia (almost happened to me during my PhD) and I have no issue with you doing that (in fact, some of my students came to me after switching from other advisors).

\end{enumerate}

\subsection{Lab Resources \& Working Environment}
...
\subsection{Conferences, Travel \& Internships}
...
\subsection{Culture, Time Off \& Social Life}
...
\subsection{Support, Conflicts \& Student Well-Being}
...
\subsection{Additional Questions Helpful to Understand the Advisor}

Questions that are not categorized into the above sections but are still helpful to understand the advisor and their advising style.


\begin{enumerate}[label=\arabic*.]
    \item What do you think about safeguarding ideas and results so that they don't get scooped?
    
    We have many good ideas and if someone else want to take some of them, it's not a big deal. In fact, if someone actually stole our ideas, we should be be amused, flattered, and consider it a compliment! 
    ...
    Thus, I encourage my students that if people---even our competitors in the same research area---are interested or curious about our work, tell them and share all the ``secrets'' that we have. Point them to our code base, e.g., \href{https://code.roars.dev}{project repos}, which are always open-source and publicly available, to see all the cool things we're doing. And if they want some code or details, just share it with them and in fact encourage them to use it and build on top of it!
...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    \item What do you think about course work and grades when evaluating prospective PhD students? If these are not important then what do you look for instead?

    Indeed, in my \href{https://code.roars.dev/phd-cs-us/}{PhD Admission Demystifying} book, I repeatedly say that that for PhD in CS GPA rarely matters (you can read more about that in the guideline). There are much more reliable indicators of a student's potential for research; LoRs and research experience/publications of course, but even small things that seemingly unrelated to research can be good indicators, e.g., the A scrapper example in~\autoref{q:a-scrapper} or someone who climbed the Himalayas.  It doesn't have to be crazy thing (though it can be), but should be something that shows the student is a self-starter, has initiative, and can get things done. 
    
    
    \autoref{fig:stefania} is a snippet from LoR I wrote for Stefania to nominate her for an outstanding undergrad award. While she has a 4.0 GPA and later show excellent research capability (published a paper with me as an undergrad), what impressed me was that she set up to do something unconventional and has impact on others as stated in the LoR.  The review committee probably agreed with me because she won the award!

    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{files/stefania.png}
    ...
    If even at the admission level I already don't care about GPA, then during the PhD, I care even less about it!  I rarely ask about course work and grades from my PhD students, but if they are not doing well in research but doing very well in course work, then I would question that as that can be a sign of them struggling in research and using course work as a way of coping or just trying to get by.  So in short, if you're my PhD student and you get 4.0 GPA in your classes, then I might question why you spend so much time on coursework instead of research. Just do enough to get by course work and focus on research.
    ...
    %co-authorship:  not actively searching for collaborators/co-authors.  But if it happens that someone can help make the work better,  share the credits.  Even if we did 99% of the work, but we can't do the other 1%, and someone else can do that 1%, then we should give them co-authorship. The person who did most of the work is still the first author, etc.  


    %As co-author, the person can claim the work is theirs, do whatever they want with it -- and doesn't need to include or involve us at all.  We don't care about that.  We just want to do good work and get it out there, and if others want to take it and run with it, that's great.  In fact, if they use it and talk a lot about it, that's great---free advertisement.

\end{enumerate}

    

\subsection{Similar Resources}
...
% ## Publication Strategy & Standards

% 1. **How do you decide when a project is “ready” for submission?**

% 2. **Do you prioritize top-tier conferences only, or are workshops and journals also valued?**

% 3. **How do you balance depth vs. number of publications?**

% 4. **Do you prefer one large, comprehensive paper or several focused papers?**

% 5. **Is it acceptable to submit bold/ambitious work that might get rejected?**

% 6. **What level of novelty do you expect before submitting a paper?**

% 7. **How do you evaluate whether a project is incremental vs. impactful?**

% ---

% ## Submissions & Deadlines

% 8. **What is your philosophy about deadlines? Are they negotiable?**

% 9. **How early should a paper draft exist before a deadline?**

% 10. **What happens if a student underestimates the time required before submission?**

% 11. **How do you handle last-minute submission crises?**

% 12. **Do you expect students to work intensely before deadlines?**

% 13. **How many submissions per year do you realistically expect from a strong PhD student?**

% ---

% ## Writing & Revision

% 14. **How many drafts do you typically go through before submission?**

% 15. **Do you rewrite students’ drafts, or only give comments?**

% 16. **What are the most common writing mistakes you see in early PhD students?**

% 17. **How do you teach students to write strong Introductions and Evaluations?**

% 18. **What distinguishes an average paper from a strong paper in your field?**

% 19. **How much time should be spent polishing vs. running more experiments?**

% ---

\subsubsection{Rebuttals}

After receiving the reviews, we will briefly scan through them to get a general sense.  If we determine that the reviewers are very negative (e.g., not even a borderline), we will likely \textbf{withdraw the paper}. This saves both our time and the reviewers' time---seriously, as a reviewer, I don't really want to read a rebuttal for a paper that is clearly bad. 

Note that even when withdrawing, we will still \textbf{thank the reviewers for their time and feedback} and say that we will withdraw the paper and try to address the concerns in the future. I am adamant about this---whether we find the feedback useful or completely garbage or if the reviewers would care or not, we will acknowledge and thank them for their time and feedback.


\paragraph{Writing Rebuttals} In most cases we \emph{will} do a rebuttal because our papers are typically not so bad that everyone hates them (i.e., we don't submit papers when they are not ready).  My students, especially the main author(s), will draft the rebuttal (usually on Google Docs because it is easier to collaborate on), and I will give feedback and revise the writing directly.  There are many tips and strategies for writing rebuttals, but for us, these are the main principles:

\begin{itemize}
    \item \textbf{Always acknowledge} the reviewers' time and feedback, even if you think they are unreasonable or won't care (most likely they don't), but we need to do it because it's the right thing to do (even if we really hate their questions or unreasonably harsh comments and that unlikely they will change their mind).
    
    \item \textbf{Don't do the rebuttal when we are emotionally upset (e.g., after reading the reviews)}. Take a break, calm down, and then come back to it. In my experience, in most case, the comments---no matter how bad they initially seem---have some truths in them (e.g., if they ask a really ``dumb'' question, they may be because we didn't explain it well enough; if they don't like the problem, then may be because we didn't motivate it well enough, etc). 
    
    \item \textbf{Don't be defensive} As mentioned, in most cases, it's \emph{something} that our paper says (or not says) that triggers the reviewers' comments, and so there's something we can do to improve our paper (regardless if it is accepted or not), and that's our main goal:  is to improve our writing and our work.
    
    
    \item \textbf{Don't promise to do something that we can't be sure we can do} Improve writing, adding figures, better motivation, etc: these are things we can promise to do. But if the reviewer asks for something that might require additional experiments or comparison with other tools, do not promise to do these!  The reason is simple: we might not be able to do these things (e.g., the existing tools might not be available, our experiments might not work, etc). Even as reviewers, when I see a rebuttal that promises to do something that is not guaranteed, I will be skeptical about it. In addition, many confs. explicitly say that they will not consider additional experiments or comparisons that are not in the original submission.

    \item \textbf{Find the champion and the defectors} This is a very common strategy---find the reviewers who clearly like the paper and provide them with the ammunition to fight against the defectors.  I personally don't find this useful because as mentioned I find even the most negative comments have some truths in them and therefore can help improve the paper. Moreover, while a reviewer might appear to be strongly for or against the paper, they might actually be the opposite (e.g., someone who appears to be a champion might not actually do anything to help the paper while someone who appears to be a defector might actually be very reasonable and open to changing their mind if we can address their concerns). 
    
    So just address all the comments with the purpose to improve the paper, and don't worry about who is a champion or a defector.
