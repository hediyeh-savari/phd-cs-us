...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    After looking at the reviews, if we determine they are very negative (e.g., not even a borderline), we might as well just \textbf{withdraw the paper}. This saves both ours and the reviewers' time. Note that even if we withdraw, we should put a note to \textbf{thank the reviewers for their time and feedback} and say that we will withdraw the paper and try to address the concerns in the future. I am adamant about this---whether we find the feedback useful or completely garbage, we will acknowledge and thank the reviewers for their time and feedback.


    However, in most cases we \emph{will} do a rebuttal because our papers are typically not so bad that everyone hates them (i.e., we don't submit papers when they are not ready).  My students, especially the main author(s), will draft the rebuttal (usually on shared Google Docs), and I will give feedback and revise the writing directly. These are the main principles: 
...
\begin{itemize}
    ...
    \item \textbf{Do not try to find the champion and the defectors} This is a very common strategy---find the reviewers who clearly like the paper and provide them with the ammunition to fight against the defectors.  I personally don't find this useful because, as mentioned, even the most negative comments have some truths in them and therefore can help improve the paper. Moreover, while a reviewer might appear to be strongly for or against the paper, they might actually be the opposite (e.g., a champion might not actually do anything to help the paper while a defector who is open to changing their mind if we can address their concerns).  So just address the comments with the purpose to improve the paper, and don't worry about who is a champion or a defector.

\end{itemize}
In short, treat rebuttal as an opportunity to improve the writing and the work, and don't worry about the rest. In most cases, especially at top confs., papers will get rejected (which we then improve and resubmit and get best paper award!\footnote{Our decompositional verification work was rejected at CAV'25 and get Research Spotlight Award at NeurIPS'25}.); but in some rare cases, rebuttal can actually change reviewers' mind as shown in~\autoref{fig:rebuttal} and we celebrate.
    
\begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{files/cvpr-acceptance.png}
        \caption{CPVR'26 paper that got accepted after rebuttal.}\label{fig:rebuttal}
\end{figure}
\end{enumerate}
