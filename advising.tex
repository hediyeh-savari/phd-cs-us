...
%Rebuttals & Dealing with Reviews
...
\begin{itemize}
    ...
    \item \textbf{Don't be defensive} ... no need to say much on this. As mentioned, in most cases, it's \emph{something} that our paper says (or not says) that triggers the reviewers' comments, and so there's something we can do to improve our paper (regardless if it is accepted or not), and that's our main goal:  is to improve our writing and our work. 
