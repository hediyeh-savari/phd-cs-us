...
\end{itemize}
In short, treat rebuttal as an opportunity to improve the writing and the work, and don't worry about the rest. Assume borderline papers are likely rejected but the responses will be useful for revise-and-resubmit. In many cases, this is exactly what would happen (papers rejected and we improve and get accepted later), but in some cases, rebuttal can actually change the outcome and people can change their mind, and we celebrate.
