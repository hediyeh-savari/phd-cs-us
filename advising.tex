...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    \item \textbf{Do we submit uncertain papers? Could be useful to see what the community thinks and get feedback}
    
    No, we only submit papers that we think are good. We don't need to send out feelers to see if the community likes our work.  If we do enough homework we should have a good idea of how the community will react to our work. We also should not use the reviewers as guinea pigs to test our work (
    besides, the comments from a couple of reviewers do not represent the ``community''). Finally, we don't need to send out papers just to get feedback---I can give you feedback and you can get feedback from your lab mates and others.
    
    So just do the work, get good results, then write a good paper about it.  
