...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    No, we only submit papers that we think are good. We don't need to send out feelers to see if the community likes our work. If we do enough homework we should have a good idea of how the community will react to our work.  And the comments from a couple of reviewers do not represent the ``community''. Finally, we don't need to send out papers just to get feedback --- I can give you feedback and you can get feedback from your lab mates and others.
