...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    \autoref{fig:stefania} is a snippet from LoR I wrote for Stefania to nominate her for an Outstanding Undergrad award. At this moment, she has not done much research, but things coming up with with these ideas and executing them (and especially do them completely volunteer without the need for any acknowledgment) is a good indicator 
    of self-motivation and initiative, which are crucial for research. The review committee probably agreed with this assessment because she won the award! 
    ...
    \item \textbf{If someone contributes very little to a paper, do they deserve co-authorship?}
    
    ``Little'' is subjective!  In general we are quite generous with co-authorship.  If someone contributes something that we can't do ourselves, even if it's a small contribution, then we should give them co-authorship. Even if they don't seem to contribute much but consistently attend meeting, give feedback, work a bit on the papers, etc., then we should give them co-authorship.
    
    Expanding a bit ``little'': in general we don't seek for co-authors to help with the work, but if it happens that someone can help make the work better, we will share the credits. Even if we did 99\% of the work, but we can't do the other 1\%, and someone else can do that 1\%, then we should give them co-authorship. The person who did most of the work is still the first author, etc.      
