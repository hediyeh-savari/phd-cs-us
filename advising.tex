...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    If we do enough homework we should have a good idea of how the community would react to our work. In fact, if our work is so good, we will change the community's mind and get them to like it. So just do the work, get good results, then write a good paper about it.  
