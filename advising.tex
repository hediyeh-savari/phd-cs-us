...
\begin{enumerate}[label=\arabic*.]
    ...
    We have so many ideas!, and if someone else want to take some of them, it's not a big deal. In fact, if someone actually stole our ideas, we should be be amused, flattered, and consider it a compliment! 
...
% Co-authors using work independently: "If a co-author takes your shared work and runs with it in a completely new direction without involving you, how do you feel about that?"
    ...
    \autoref{fig:stefania} is a snippet from a LoR I wrote for my undergrad student to nominate her for an Outstanding Undergrad award. At that moment, she has not done much research, but the things mentioned in the LoR impressed me 
    and shows self-motivation and initiative. The last sentence is a bit of self-deprecating humor but it's a way to say that the pure altruistic work from her puts her in a different league, even makes makes NSF CAREER recipients
    feel inadequate! The award committee seems to agree with the assessment as she won the award out of many nominees.
