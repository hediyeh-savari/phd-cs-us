...
\begin{enumerate}[label=\arabic*.]
   ...
   I also aim to determine what my students are interested in and good at, and then help them find projects that fit their interests and strengths. This is not just for research, but also for other things. E.g., in our Thanksgiving party, which I host at my house every year for my lab and their families, I delegate tasks to students based on their strengths and interests: I found out that Linhan is very good at cooking, so I appointed him as our turkey ``czar'' responsible for a 20+ lb turkey roasting for 30 people!
    ...
    That said, I am open to new things \emph{if} you can convince me that they are interesting and worth pursuing. The best way to do that is as follows: if you come up with an idea that is not directly related to my research interests, \emph{DO NOT} tell me about it as I will likely hate it and talk you out of it. Instead, you should just pursue it (while still working on something related to my interests), and build \emph{a prototype} and achieve some \emph{good results}. If you can show me that your idea works and has potential, then I will be more than happy to support you in that direction. This happens multiple times in my lab, and in fact I believe many of my students are working on secret projects that I don't know about yet!
