...
This document is a living document in Roars Lab's Github repo (\url{https://code.roars.dev/phd-cs-us/lab-manual.tex}) and will be updated periodically. Lab members, who all have write access, are encouraged to provide feedback and suggest changes to improve its clarity and usefulness.
