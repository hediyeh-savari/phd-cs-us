...
\subsection{VPN for Lab Servers} You will need VPN and Computing access to log into lab servers remotely. Send an email like below to \href{mailto:cechelp@gmu.edu}{cechelp@gmu.edu} and also CC the PI. 
...
\subsection{Connecting to Wifi \texttt{Eduroam}}
\begin{itemize}
